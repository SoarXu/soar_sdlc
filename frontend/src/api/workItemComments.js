...
export function fetchWorkItemCommentMentionUsers(objectType, objectId) {
  return http.get('/work-item-comments/mention-users', { params: { object_type: objectType, object_id: objectId } })
}
