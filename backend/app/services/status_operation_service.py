    ...
    return [
        {
            ...
            "workflow_definition_id": operation.workflow_definition_id,
            "from_state_id": operation.from_state_id,
            "to_state_id": operation.to_state_id,
            "from_state_name": operation.from_state_name,
            "to_state_name": operation.to_state_name,
