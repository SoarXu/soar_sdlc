...
assert.match(designer, /@remove-state="removeSelectedState"/)
...
assert.match(drawer, /emit\('remove-state'/)
...
const removeSelectedStateBody = functionBody(designer, 'removeSelectedState', 'removeSelectedTransition')
assert.match(removeSelectedStateBody, /initialStateId\.value === stateId/)
assert.match(removeSelectedStateBody, /transitions\.value\.some/)
assert.match(removeSelectedStateBody, /ElMessage\.warning/)
